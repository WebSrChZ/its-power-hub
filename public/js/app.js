/* ─── DATA ─── */
const POSTS = [
  { id:'jun01',day:2,wday:'Ter',pillar:'v',num:'01/12',
  ...
  { id:'jun02',day:4,wday:'Qui',pillar:'c',num:'02/12',
  ...
  { id:'jun03',day:6,wday:'Sab',pillar:'a',num:'03/12',
  ...
  { id:'jun04',day:9,wday:'Ter',pillar:'a',num:'04/12',
  ...
  { id:'jun06',day:13,wday:'Sab',pillar:'a',num:'06/12',
  ...
  { id:'jun07',day:16,wday:'Ter',pillar:'c',num:'07/12',
...
const SEDE_MAP = {
  ...
  jul06:'ambas',jul07:'ambas',jul08:'ambas',jul09:'bv',jul10:'centro',
...
[
  { id:'jul01',day:2,wday:'Qui',pillar:'a',num:'01/12',
  ...
  { id:'jul02',day:4,wday:'Sab',pillar:'v',num:'02/12 — Campanha Inverno',
  ...
  { id:'jul03',day:7,wday:'Ter',pillar:'a',num:'03/12',
    title:'Mito ou Verdade: suar mais significa queimar mais gordura?',
    desc:'Quadro fixo Mito ou Verdade. Veredito: MITO — suor é termorregulação (controle de temperatura), não medida de gasto calórico. O que queima gordura é o gasto de energia do treino. Ciência + demonstração.',
    tags:['Mito ou Verdade','Quadro fixo','Educativo']},
  { id:'jul04',day:9,wday:'Qui',pillar:'c',num:'04/12',
  ...
  { id:'jul05',day:11,wday:'Sab',pillar:'a',num:'05/12',
    title:'Aqui tem muito mais que musculação.',
    desc:'Power Training, 4move (mobilidade e longevidade), dança, personal, avaliação física, lojinha — e os diferenciais da unidade Bela Vista: climatização e espaço Kids.',
    tags:['Além da musculação','Modalidades','4move','Diferenciais BV']},
  { id:'jul06',day:14,wday:'Ter',pillar:'v',num:'06/12 — Power Club',
  ...
  { id:'jul08',day:16,wday:'Qui',pillar:'a',num:'08/12',
    title:'Professor responde: por que meu agachamento não evolui?',
    desc:'Quadro fixo Professor Responde. Dúvida real de aluno: o erro mais comum no agachamento (joelho/profundidade) e a correção. CTA: manda tua dúvida no direct.',
    tags:['Professor Responde','Quadro fixo','Educativo']},
  { id:'jul09',day:18,wday:'Sab',pillar:'c',num:'09/12',
    title:'Cadeira na parede. 1 minuto. Você aguenta?',
    desc:'Quadro fixo Desafio do Mês: da prancha de 30s (junho) para 1 minuto de cadeira na parede (wall sit). Isometria que queima — alta retenção e marcações.',
    tags:['Desafio','Quadro fixo','Formato viral']},
  { id:'jul10',day:20,wday:'Seg',pillar:'c',num:'10/12 — Dia do Amigo',
    title:'Dia do Amigo: quem treina junto, evolui junto.',
    desc:'Campanha Dia do Amigo: cada aluno convida um amigo para treinar grátis na unidade Centro (a maior estrutura de Cláudio). Duplas treinando, depoimentos e CTA de marcação + convite.',
  ...
  { id:'jul12',day:28,wday:'Ter',pillar:'c',num:'12/12',
...
].forEach(p => { p.month = 'jul'; p.icon = PILLAR[p.pillar].icon; p.sede = SEDE_MAP[p.id] || 'ambas'; POSTS.push(p); });
...
[
  ...
  { id:'ago02',day:4,wday:'Ter',pillar:'a',num:'02/12',
    title:'Mito ou Verdade: pular o dia de perna não faz diferença?',
    desc:'Quadro fixo Mito ou Verdade. Veredito: MITO — perna é o maior grupo muscular (gasto calórico, hormônios, postura). Ciência + demonstração.',
    tags:['Mito ou Verdade','Quadro fixo','Educativo']},
  ...
  { id:'ago05',day:11,wday:'Ter',pillar:'a',num:'05/12',
    ...
    desc:'Mobilidade, longevidade e consciência corporal com yoga e outros recursos. + Power Training e dança — na unidade Bela Vista, climatizada e com espaço Kids.',
    tags:['Além da musculação','4move','Mobilidade','Diferenciais BV']},
  ...
  { id:'ago07',day:15,wday:'Sab',pillar:'c',num:'07/12',
    title:'Desafio do mês: quantos agachamentos em 30 segundos?',
    desc:'Quadro fixo Desafio do Mês — exercício novo a cada mês. Agosto: agachamento contra o relógio. Participação + marcação.',
    tags:['Desafio','Quadro fixo','Formato viral']},
  { id:'ago08',day:18,wday:'Ter',pillar:'a',num:'08/12',
    title:'Professor responde: por que meu supino não evolui?',
    desc:'Quadro fixo Professor Responde. Dúvida real de aluno: o erro do ombro avançado no supino e a correção. CTA: manda tua dúvida no direct.',
    tags:['Professor Responde','Quadro fixo','Educativo']},
  ...
  { id:'ago11',day:25,wday:'Ter',pillar:'a',num:'11/12',
    ...
    desc:'A maior estrutura de Cláudio, mais equipamentos, atendimento humanizado e 24 anos de tradição — os diferenciais reais da unidade Centro.',
    tags:['Diferenciais','Estrutura Centro','Tradição']},
  { id:'ago12',day:27,wday:'Qui',pillar:'c',num:'12/12',
